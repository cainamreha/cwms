...
/**
 * GbookConfigElement class
 * 
 * content type => gbook
 */
class GbookConfigElement extends ConfigElementFactory implements ConfigElements
{

	/**
	 * Gibt ein GbookConfigElement zurück
	 * 
	 * @access	public
	...
	public function getCreateElementHtml()
	{
		...
		$output	.=	'<label class="cc-group-label">{s_option:' . $this->conType . '}</label>' . PHP_EOL;
