...
/**
 * SearchConfigElement class
 * 
 * content type => search
 */
class SearchConfigElement extends ConfigElementFactory implements ConfigElements
{

	/**
	 * Gibt ein SearchConfigElement zurück
	 * 
	 * @access	public
	...
	public function setParams()
	{
		...
		if(empty($this->params["s"])) $this->params["s"] = 0;
		if(empty($this->params["a"])) $this->params["a"] = 0;
		if(empty($this->params["n"])) $this->params["n"] = 0;
		if(empty($this->params["p"])) $this->params["p"] = 0;
