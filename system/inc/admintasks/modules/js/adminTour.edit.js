	   ...
	   if(cc.adminLang == "de"){
		...
		stepSrc.each(function(i,e){
			...
			|| $('.adminTask-tpl.adminType-edit').length
				...
				switch(i){
					case 0:
						...
						break;
					case 1:
						sTarget		= document.querySelector(".editPageDetailsDiv .page");
						break;
					case 2:
						sTarget		= document.querySelector(".editPageContentsDiv .toggleCons");
						break;
					case 3:
						sTarget		= document.querySelector('.cc-edit-element-box .conNr');
						xOffset		= "center";
						aOffset		= "center";
						break;
					case 4:
						sTarget		= document.querySelector('.cc-edit-element-box .editButtons-panel');
						sPlacecm	= "left";
						break;
					case 5:
						sTarget		= document.querySelector('.cc-edit-element-box .editButtons-panel');
						...
						break;
					case 6:
						sTarget		= document.querySelector('.controlBar');
						xOffset		= "center";
						aOffset		= "center";
						break;
				}
			...
			// else page list
				switch(i){
					case 0:
						sTarget		= document.querySelector(".adminTask-edit .cc-section-heading");
						break;
					case 1:
						sTarget		= "chooseLang";
						sPlacecm	= "left";
						break;
					case 2:
						sTarget		= document.querySelector(".pageListItem .pageID + .editButtons-panel");
						sPlacecm	= "left";
						break;
					case 3:
						sTarget		= document.querySelector(".pageListItem .editButtons-panel.panel-left");
						sPlacecm	= "right";
						break;
					case 4:
						sTarget		= document.querySelector('.pageListItem .editButtons-panel[data-id*="contextmenu-1-b"]');
						xOffset		= "center";
						aOffset		= "center";
						break;
					case 5:
