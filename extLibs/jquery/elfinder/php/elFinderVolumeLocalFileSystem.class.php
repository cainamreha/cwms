...
class elFinderVolumeLocalFileSystem extends elFinderVolumeDriver {
	...
	public function __construct() {
		...
		$this->options['icon']     = (defined('ELFINDER_IMG_PARENT_URL')? (rtrim(ELFINDER_IMG_PARENT_URL, '/').'/') : PROJECT_HTTP_ROOT . '/extLibs/jquery/elfinder/').'img/volume_icon_local.png';
	}
	...
	protected function _inpath($path, $parent) {
		return $path == $parent || strpos($path, $parent.DIRECTORY_SEPARATOR) === 0 || strpos($path, $parent.'/') === 0;
	}
