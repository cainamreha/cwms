...
(function($) {
    ...
    $.fn.jzoom = function(options) {
        return this.each(function() {
			...
			var joomW	= $jzoom.width();
			var joomH	= $jzoom.height();
			...
			var jzoomOLft	= $jzoom.offset().left;

			// Adjust position of zoomDiv according to horizontal space
			if(options.position == "right"
			&& jzoomOLft > parseInt(winW - (jzoomOLft + joomW))
			){
			...
			if(winW < 768){
				...
				options.offsetY		= options.offsetX;
			}
