    ...
    $.fn.filterizr.prototype = {
        ...
        setOptions: function(options) {
            ...
            if (options.callbacks) {
                if (!options.callbacks.onFilteringStart)
                    self.options.callbacks.onFilteringStart = function(obj) { };
                if (!options.callbacks.onFilteringEnd)
                    self.options.callbacks.onFilteringEnd = function(obj) { };
                if (!options.callbacks.onShufflingStart)
                    self.options.callbacks.onShufflingStart = function(obj) { };
                if (!options.callbacks.onShufflingEnd)
                    self.options.callbacks.onShufflingEnd = function(obj) { };
                if (!options.callbacks.onSortingStart)
                    self.options.callbacks.onSortingStart = function(obj) { };
                if (!options.callbacks.onSortingEnd)
                    self.options.callbacks.onSortingEnd = function(obj) { };
            }
        ...
        */
        _getFiltrItems: function() {
            var self       = this,
            filtrItems = $(self.find('.' + self.options.itemClass)),
            itemsArray = [];
        ...
        */
        _setupControls: function() {
            ...
            //Filter controls
            $('*[data-filter]', parent).click(function() {
            ...
            $('*[data-multifilter]', parent).click(function() {
            ...
            //Shuffle control
            $('*[data-shuffle]', parent).click(function() {
                self.shuffle();
            });
            //Sort controls
            $('*[data-sortAsc]', parent).click(function() {
                var sortAttr = $('*[data-sortOrder]').val();
                self.sort(sortAttr, 'asc');
            });
            $('*[data-sortDesc]', parent).click(function() {
                var sortAttr = $('*[data-sortOrder]').val();
                self.sort(sortAttr, 'desc');
            });
            //Search control
            $('input[data-search]', parent).keyup(function() {
        ...
        */
        _setupEvents: function() {
            ...
            .on('filteringStart', function() {
                self.options.callbacks.onFilteringStart(self);
            })
            //onFilteringEnd event
            .on('filteringEnd', function() {
                self.options.callbacks.onFilteringEnd(self);
            })
            //onShufflingStart event
            .on('shufflingStart', function() {
                self._isShuffling = true;
                self.options.callbacks.onShufflingStart(self);
            })
            //onFilteringEnd event
            .on('shufflingEnd', function() {
                self.options.callbacks.onShufflingEnd(self);
                self._isShuffling = false;
            })
            //onSortingStart event
            .on('sortingStart', function() {
                self._isSorting = true;
                self.options.callbacks.onSortingStart(self);
            })
            //onSortingEnd event
            .on('sortingEnd', function() {
                self.options.callbacks.onSortingEnd(self);
                self._isSorting = false;
            });
        },
        ...
        */
        _calcItemPositions: function() {
            ...
            //Container data
            containerHeight = 0,
            cols = Math.round(self.width() / self.find('.' + self.options.itemClass).outerWidth()),
            rows = 0,
            //Item data
