...
(function() {
  ...
  ImagePicker = (function() {
    ...
    ImagePicker.prototype.build_and_append_picker = function() {
      ...
      this.create_picker();
	  if(this.opts.target_box){
		  this.opts.target_box.append(this.picker);
	  }else{
  ...
  ImagePickerOption = (function() {
    ...
    ImagePickerOption.prototype.title = function() {
      if (this.option.data("img-title")) {
        return this.option.data("img-title");
      } else {
        return "";
      }
    };
    ...
    ImagePickerOption.prototype.create_node = function() {
      ...
      if (this.opts.show_title) {
        thumbnail.attr('title', this.title());
      }
