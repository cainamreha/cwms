...
/**
 * TestPluginConfigElement class
 * 
 * content type => test
 */
class TestPluginConfigElement extends ConfigElementFactory implements ConfigElements
{

	/**
	 * Gibt ein TestPluginConfigElement zurück
	 * 
	 * @access	public
