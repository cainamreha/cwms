...
CREATE TABLE IF NOT EXISTS `cc_contents_main` (
  ...
  `con17_de` mediumtext NOT NULL,
  `type-con17` varchar(50) NOT NULL,
  `styles-con17` text NOT NULL,
  `con18_de` mediumtext NOT NULL,
  `type-con18` varchar(50) NOT NULL,
  `styles-con18` text NOT NULL,
  `con19_de` mediumtext NOT NULL,
  `type-con19` varchar(50) NOT NULL,
  `styles-con19` text NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
