...
CREATE TABLE `cc_forms` (
  ...
  `notice_success_en` varchar(300) COLLATE utf8_unicode_ci NOT NULL,
  `notice_error_de` varchar(300) COLLATE utf8_unicode_ci NOT NULL,
  `notice_error_en` varchar(300) COLLATE utf8_unicode_ci NOT NULL,
  `notice_field_de` varchar(200) COLLATE utf8_unicode_ci NOT NULL,
  `notice_field_en` varchar(200) COLLATE utf8_unicode_ci NOT NULL,
  ...
  `add_labels_en` varchar(2048) COLLATE utf8_unicode_ci NOT NULL,
