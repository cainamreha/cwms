...
$(document).ready(function(){
	...
	$('*[data-toggle]:not([data-context="navbar"],[data-context="modal"])').bind("click tab", function(){
...
(function($){
	...
	$.showAccountMenu = function(elem){
		...
		$("#accountMenu").fadeIn();
		$("#header .fixedNav .navbar").animate({top:'45px'}, 300);
	...
	$.hideAccountMenu = function(elem){
		...
		$("#header .fixedNav .navbar").stop(true,false).animate({top:'0'}, 300);
